...
public:
   ...
   static bool IsOn() { return DoCheck; }
...
public:
   ...
   GeneralMatrix* Evaluate(MatrixType = MatrixTypeUnSp) { return gm; };
   MatrixBandWidth BandWidth() const;
...
class VectorException : public Logic_error    // can't convert to vector
{
public:
   static unsigned long Select;          // for identifying exception
   VectorException();
