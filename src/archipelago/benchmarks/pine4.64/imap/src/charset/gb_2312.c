/*
 * Program:	GB 2312 conversion table
 *
 * Author:	Mark Crispin
...
#define BASE_GB2312_KU 0x21
#define BASE_GB2312_TEN 0x21
#define MAX_GB2312_KU 87
#define MAX_GB2312_TEN 94


#define GBTOUNICODE(c,c1,ku,ten)					\
  ((((ku = (c & 0x7f) - BASE_GB2312_KU) < MAX_GB2312_KU) &&		\
    ((ten = (c1 & 0x7f) - BASE_GB2312_TEN) < MAX_GB2312_TEN)) ?		\
