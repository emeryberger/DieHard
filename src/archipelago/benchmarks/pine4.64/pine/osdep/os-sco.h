/*----------------------------------------------------------------------
  $Id: os-sco.h 13025 2003-05-23 16:05:21Z hubert $
...
/*----------------------------------------------------------------------
   ...
   for your configuration.  This is the SCO version of the os.h file.
...
#define POSTPONED_MSGS            "ppnd-msgs"
#define INTERRUPTED_MAIL          ".pine-intr"
...
/*----------------------------------------------------------------------
   Default mail posting agent (must use sendmail's "-t" or similar)
 ----*/
#define	DF_SENDMAIL_PATH	  "/usr/lib/sendmail -oi -oem -t"
