/*----------------------------------------------------------------------
  $Id: os-bsd.h 13025 2003-05-23 16:05:21Z hubert $
...
void free();
/*
 * This BSD stuff is lame. We'd like to just include ../c-client/osdep.h
 * like we do for the other systems, but that osdep.h includes sys/dir.h which
 * has already been included by ../pico/headers.h, and the double include
 * chokes us. So these are the other local includes from ../c-client/osdep.h.
 */
...
/*----------------------------------------------------------------------
   ...
   for your configuration.  This is the BSD 4.3 version of the os.h file.
