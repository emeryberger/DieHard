/*----------------------------------------------------------------------
  $Id: os-aux.h 13025 2003-05-23 16:05:21Z hubert $
...
/*----------------------------------------------------------------------
   ...
   for your configuration.  This is the A/UX 3.0 version of the os.h file.
...
#define CHECK_POINT_FREQ   (10) /* Check point the mail file if there have been
