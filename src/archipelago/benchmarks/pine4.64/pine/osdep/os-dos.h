...
/*----------------------------------------------------------------------
  $Id: os-dos.h 13025 2003-05-23 16:05:21Z hubert $
...
#define DF_FOLDER_EXTENSION       "MTX"
...
/*----------------------------------------------------------------------
    This is DOS specific and is used to fake the results of SIGALRM
 signal handling without an alarm system call.
 ----*/
#define  ALARM_BLIP()  fake_alarm_blip()
