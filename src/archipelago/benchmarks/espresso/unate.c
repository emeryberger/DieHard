...
pset_family A;			/* disposes of A */
{
	...
	/* Check for "essential" columns */
	    ...
	    Abar = unate_complement(abs_covered_many(A, rstrict));
	    sf_free(A);
	...
	/* else, recur as usual */
	    ...
	    max_i = abs_select_restricted(A, rstrict);
