...
/**
 * @file   marsaglia.h
 * @brief  A fast random number generator, based on code from George Marsaglia.
 * @author Emery Berger <http://www.cs.umass.edu/~emery>
 * @note   Copyright (C) 2005 by Emery Berger, University of Massachusetts Amherst.
 *
 **/

#ifndef _MARSAGLIA_H_
#define _MARSAGLIA_H_
...
public:
  ...
  Marsaglia (unsigned long seed1, unsigned long seed2)
    : z (seed1),
      w (seed2)
  {
  }
  ...
  inline unsigned long next (void) {
    unsigned long n = ((z=36969*(z&65535)+(z>>16))<<16)+(w=18000*(w&65535)+(w>>16));
    return n;
  }
};

/* See http://www.ciphersbyritter.com/NEWS4/RANDC.HTM */
