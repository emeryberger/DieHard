 ...
 * @note   Copyright (C) 2011 by Emery Berger, University of Massachusetts Amherst.
 */
...
/*
  ...
  Copyright (c) 1998-2010 by Emery Berger
...
#define CUSTOM_DLLNAME WinWrapDllMain
...
static bool PatchMeIn (void)
{
  ...
  static const char * RlsCRTLibraryName[] = {TEXT("MSVCR71.DLL"), TEXT("MSVCR80.DLL"), TEXT("MSVCR90.DLL"), TEXT("MSVCR100.DLL"), TEXT("MSVCP100.DLL"), TEXT("MSVCRT.DLL") };
